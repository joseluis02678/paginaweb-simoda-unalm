    ...
    <div className="app-container">
      ...
      <section id="inicio" className="hero-section">
        <div className="hero-inner">
          <span className="hero-eyebrow">Círculo de Investigación · UNALM</span>
      ...
      <section id="proyectos" className="section section-alt">
        ...
        <div className="projects-grid">
          <div className="project-card">
            <span className="field-code">PC</span>
          ...
          <div className="project-card">
            <span className="field-code">AS</span>
          ...
          <div className="project-card">
            <span className="field-code">ST</span>
          ...
          <div className="project-card">
            <span className="field-code">IS</span>
      ...
      <section id="integrantes" className="section">
        ...
        <p className="section-description">
          Estudiantes de Estadística Informática organizados en tres grupos de investigación,
          cada uno guiado por un docente responsable.
        </p>
        <div className="grupos-grid">
          <div className="grupo-card">
            <span className="field-code">G1</span>
            <h3>Optimización del riego de maíz con aprendizaje por refuerzo</h3>
            <p className="grupo-descripcion">
              Optimización del uso del agua en el riego de maíz con aprendizaje por refuerzo
              bajo condiciones de escasez en la región de la costa del Perú.
            </p>
            <p className="grupo-docente">Docente responsable: Carlos López de Castilla</p>
            <ul className="grupo-miembros">
              <li>Michel Alexis Bañares Gutiérrez</li>
              <li>Rodrigo Céspedes Jamryk</li>
              <li>Karen Huamani Ccorpuna</li>
            </ul>
          </div>

          <div className="grupo-card">
            <span className="field-code">G2</span>
            <h3>Machine Learning en calibración de espectrómetros</h3>
            <p className="grupo-descripcion">
              Implementación de Machine Learning en la calibración de espectrómetros para
              el análisis de nutrientes en suelos.
            </p>
            <p className="grupo-docente">Docente responsable: Jesús Gamboa</p>
            <ul className="grupo-miembros">
              <li>Claudia María Escobar Champi</li>
              <li>Maricielo Huamán Cóndor</li>
              <li>Anderson Pedro Escobar Valdivia</li>
              <li>Kemely Yamile Flores Curi</li>
            </ul>
          </div>

          <div className="grupo-card">
            <span className="field-code">G3</span>
            <h3>Dinámica Funcional de la Producción de Cacao en San Martín</h3>
            <p className="grupo-descripcion">
              Análisis de Datos Funcionales (FDA) sobre la producción de cacao en los
              distritos de Pólvora, Tocache y Saposoa, región San Martín (2016–2025).
            </p>
            <p className="grupo-docente">Docente responsable: Diana Rebaza Fernandez</p>
            <ul className="grupo-miembros">
              <li>Eduardo Arévalo Aquije</li>
              <li>Anthony Luis Mandujano Cortez</li>
              <li>José Luis Garay Ramos</li>
              <li>Jonnathan Jesús Pedraza Laboriano</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <footer className="footer">
        ...
        <p>Hecho por estudiantes de Estadística Informática</p>
      </footer>
    </div>
  )
}
